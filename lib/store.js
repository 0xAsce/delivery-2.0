...
export function createOrder(db,{shop,items,total,note="",address="",deliveryTime="asap"}){
 const order={
  id:"CMD-"+Date.now().toString().slice(-7),
  shopId:shop.id,shopName:shop.shopName,phone:shop.phone,items,total,note,address,deliveryTime,status:"pending",
